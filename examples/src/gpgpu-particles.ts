 ...
 *
 *
 * Create a more controlled example focusing on composability of particle
 * features.
 *
 * So:
 *
 ...
 *
 * Simple Forces
 * Curl Noise, Gravity, Floor / Bounce
 *
 * These will be individual state textures running a seperate sim.
 * But configured via same api.
 *
 * Emitters can have translation/scale and rotation controls.
 *
 */
